...
#define LAYOUT_LAYER_BASE                                                                     \
       KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_COMBO_1,    KC_COMBO_2,    KC_O,    KC_COMBO_3, \
...
#define LAYOUT_LAYER_POINTER                                                                  \
    DRGSCRL, XXXXXXX, XXXXXXX, DPI_MOD, S_D_MOD, S_D_MOD, DPI_MOD, DRAGSCROLL_MODE_TOGGLE, DRGSCRL, DRGSCRL, \
    ______________HOME_ROW_GACS_L______________, ______________HOME_ROW_GACS_R______________, \
    _______, DRGSCRL, _______, EE_CLR,  QK_BOOT, QK_BOOT, EE_CLR,  SNIPING, DRGSCRL, _______, \
...
#define LAYOUT_LAYER_NAVIGATION                                                               \
    ...
    _______________DEAD_HALF_ROW_______________,  KC_INS, KC_HOME, KC_PGDN, KC_PGUP,  KC_DEL, \
...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    ...
    LSFT(KC_QUOT),  KC_DLR, KC_PERC, KC_CIRC, KC_PLUS, ______________HOME_ROW_GACS_R______________, \
...
#define _POINTER_MOD(                                                  \
    ...
    ...)                                                               \
             ...
             L10,         L11,         L12,         L13,         L14,  \
             R15,         R16,         R17,         R18,         R19,  \
      _L_PTR(L20),        L21,  _L_PTR(L22),         L23,         L24, \
